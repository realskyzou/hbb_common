...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("RustDesk(前沿专用版)".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["49.7.65.194"];
pub const RS_PUB_KEY: &str = "fzGMqCtCfUWqpXwxzbFDYLzki3qhkM2KL2zi8t7TE+c=";
